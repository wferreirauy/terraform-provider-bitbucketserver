...
See [User Guide](https://wferreirauy.github.io/terraform-provider-bitbucketserver) for details on all the provided data and resource types.
...
- clone this repository to `$GOPATH/src/github.com/wferreirauy/terraform-provider-bitbucketserver`
