...
terraform {
  ...
  required_providers {
    bitbucketserver = {
      source  = "wferreirauy/bitbucketserver"
    }
  }
}
```
...
$ mkdir -p ~/.terraform.d/plugins && \
      curl -Ls https://api.github.com/repos/wferreirauy/terraform-provider-bitbucketserver/releases/latest \
...
If you don't want to use the one-liner above, you can download a binary for your system from the [release page](https://github.com/wferreirauy/terraform-provider-bitbucketserver/releases),
